    ...
    def _apply_frameworks(self, company_data: dict) -> dict:
        ...
        frameworks["swot"] = {
            ...
            "weaknesses": swot_data.get(
                "weaknesses",
                ["Limited geographic presence", "High customer acquisition cost", "Technical debt"],
            ),
            "opportunities": swot_data.get(
                "opportunities",
                ["Growing market demand", "M&A opportunities", "New product categories"],
            ),
...
if __name__ == "__main__":
    ...
    example_company = {
        ...
        "organizational_capability": {"talent": 70, "culture": 65, "leadership": 75, "agility": 60},
        "growth_potential": {
            "market_size": 80,
