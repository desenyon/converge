            ...
            close.append(
                {
                    ...
                    "verdict": "Very close — recheck assumptions"
                    if gap_pct <= 5
                    else "Close — worth a second look",
                }
            )
    return close
...
def print_report(data: dict):
    ...
    if unstable:
        ...
        print(f"  Winner: {winner}")
        print("  Confidence: HIGH — winner is stable across all weight scenarios")
        print()
...
def main():
    ...
    parser.add_argument("--sample", action="store_true", help="Show sample data structure and exit")
