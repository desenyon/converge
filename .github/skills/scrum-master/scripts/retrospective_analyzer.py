...
def analyze_action_item_completion(retros: list[RetrospectiveData]) -> dict[str, Any]:
    ...
    if not all_action_items:
        return {"total_action_items": 0, "completion_rate": 0.0, "average_completion_time": 0.0}
