...
class DashboardGenerator:
    ...
    def create_service_definition(
        self, service_type: str, name: str, criticality: str = "medium"
    ) -> dict[str, Any]:
    ...
    def generate_dashboard_specification(
        self, service_def: dict[str, Any], target_role: str = "sre"
    ) -> dict[str, Any]:
    ...
    def _generate_dashboard_layout(
        self, service_def: dict[str, Any], role_config: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        return [
            {
                ...
                "targets": [{"expr": f'up{{service="{service_name}"}}', "legendFormat": "Status"}],
                "field_config": {
                    "overrides": [
                        {
                ...
                "options": {"orientation": "horizontal", "textMode": "value_and_name"},
            },
            {
                "id": "slo_summary",
    ...
    def _create_resource_panels(self, service_def: dict[str, Any]) -> list[dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "field_config": {
                    "defaults": {"color": {"mode": "palette-classic"}, "unit": "binBps"}
                },
            },
            {
                "id": "disk_io",
        ...
        return [
            {
                ...
                "field_config": {
                    "defaults": {
                        "color": {"mode": "palette-classic"},
                        "custom": {"drawStyle": "line", "lineStyle": {"dash": [10, 10]}},
                    }
                },
            }
        ]
    ...
    def generate_grafana_json(self, dashboard_spec: dict[str, Any]) -> dict[str, Any]:
        ...
        grafana_json = {
            "dashboard": {
                ...
                "templating": {"list": dashboard_spec["variables"]},
    ...
    def _convert_panels_to_grafana_format(
...
"""
    ...
    def export_specification(
        self, dashboard_spec: dict[str, Any], output_file: str, format_type: str = "json"
    ):
...
Examples:
    ...
    parser.add_argument("--output", "-o", help="Output dashboard specification file")
    parser.add_argument(
        "--service-type",
    ...
    parser.add_argument("--doc-output", help="Generate documentation file")
    parser.add_argument(
        "--summary-only", action="store_true", help="Only display summary, do not save files"
    )
    ...
    try:
        ...
        if not args.summary_only:
            output_file = (
                args.output or f"{service_def['name'].replace(' ', '_').lower()}_dashboard.json"
            )
