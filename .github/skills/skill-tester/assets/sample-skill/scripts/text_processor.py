...
class TextProcessor:
    ...
    def analyze_text(self, text: str) -> dict[str, Any]:
        ...
        if words:
            ...
            stats["most_frequent"] = {"word": most_common[0], "count": most_common[1]}
        else:
    ...
    def process_file(self, file_path: str) -> dict[str, Any]:
        ...
        try:
            ...
            raise UnicodeDecodeError(
                f"Cannot decode file with {self.encoding} encoding: {file_path}"
            )
...
class OutputFormatter:
    ...
    def format_human_readable(data: dict[str, Any]) -> str:
        ...
        lines.append(
            f'Most frequent word: "{most_frequent.get("word", "")}" ({most_frequent.get("count", 0)} occurrences)'
        )
...
class FileManager:
    ...
    def write_output(self, content: str, output_path: str | None = None):
...
def analyze_command(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        print(f"Error: {e}", file=sys.stderr)
        print("Try using --encoding option with different encoding", file=sys.stderr)
        return 1
