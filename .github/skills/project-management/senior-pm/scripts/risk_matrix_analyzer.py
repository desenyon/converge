...
class Risk:
    ...
    def __init__(self, data: dict[str, Any]):
        ...
        self.target_resolution: str | None = data.get("target_resolution")
        ...
        self.cost_impact: float | None = data.get("cost_impact")
        self.schedule_impact: int | None = data.get("schedule_impact_days")
...
def analyze_risk_trends(
    current_risks: list[Risk], historical_data: list[dict] | None = None
) -> dict[str, Any]:
