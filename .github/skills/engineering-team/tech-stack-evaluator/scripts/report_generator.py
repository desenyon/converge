...
class ReportGenerator:
    ...
    def __init__(self, report_data: dict[str, Any], output_context: str | None = None):
        """
    ...
    def generate_executive_summary(self, max_tokens: int = 300) -> str:
        ...
        summary_parts.append("\n---\n")
        summary_parts.append("*For detailed analysis, request full report sections*\n")

        return "".join(summary_parts)

    def generate_full_report(self, sections: list[str] | None = None) -> str:
        """
...
"""
    ...
    def _generate_section(self, section_name: str) -> str | None:
        """
    ...
    def _section_migration_analysis(self) -> str:
        ...
        if effort:
            ...
            parts.append(
                f"- Total Effort: {person_months:.1f} person-months ({total_hours:.0f} hours)"
            )
    ...
    def export_to_file(self, filename: str, sections: list[str] | None = None) -> str:
        """
