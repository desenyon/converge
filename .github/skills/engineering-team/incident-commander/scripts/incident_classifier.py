...
{standard_contact}""",
        ...
        return {
            "classification": {
                ...
                "confidence": self._calculate_confidence(
                    description, affected_users, business_impact
                ),
    ...
    def _classify_severity(
        self, description: str, affected_users: str, business_impact: str, duration: int
    ) -> str:
    ...
    def _generate_communication(self, severity: str, incident_data: dict) -> dict:
        ...
        communication = {
            "subject": template["subject"].format(
                service=service,
                brief_description=description[:50] + "..."
    ...
    def _calculate_confidence(
        self, description: str, affected_users: str, business_impact: str
    ) -> float:
...
def interactive_mode():
    ...
    while True:
        try:
            ...
            affected_users = (
                input("Affected users (e.g., '50%', 'all users'): ").strip() or "unknown"
            )
