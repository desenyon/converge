...
class MigrationPlanner:
        ...
        return {
            "database": [
                RiskItem(
                    ...
                    "critical",
                    "high",
                    "Implement comprehensive backup and validation procedures",
                    "DBA Team",
                ),
                RiskItem(
                    "technical",
                    ...
                    "high",
                    "high",
                    "Use blue-green deployment and phased migration approach",
                    "DevOps Team",
                ),
                RiskItem(
                    "business",
                    ...
                    "high",
                    "high",
                    "Communicate timeline and provide alternate workflows",
                    "Business Owner",
                ),
                RiskItem(
                    "operational",
                    ...
                    "critical",
                    "critical",
                    "Execute full rollback procedures in staging environment",
                    "QA Team",
                ),
            ],
            "service": [
                ...
                RiskItem(
                    ...
                    "high",
                    "high",
                    "Document feature mapping and acceptance criteria",
                    "Product Owner",
                ),
                RiskItem(
                    "operational",
                    ...
                    "medium",
                    "medium",
                    "Set up dual monitoring and alerting systems",
                    "SRE Team",
                ),
            ],
            "infrastructure": [
                RiskItem(
                    ...
                    "critical",
                    "high",
                    "Implement redundant network paths and monitoring",
                    "Network Team",
                ),
                RiskItem(
                    "technical",
                ...
                RiskItem(
                    "business",
                    "Cost overrun during transition",
                    "high",
                    "medium",
                    "medium",
                ...
                RiskItem(
                    ...
                    "medium",
                    "medium",
                    "Provide training and create detailed documentation",
                    "Platform Team",
                ),
            ],
        }
    ...
    def _estimate_duration(
        self, migration_type: str, migration_pattern: str, complexity: str
    ) -> int:
    ...
    def _assess_risks(self, spec: dict[str, Any]) -> list[RiskItem]:
        ...
        if constraints.get("max_downtime_minutes", 480) < 60:
            additional_risks.append(
                RiskItem(
                    ...
                    "medium",
                    "high",
                    "Implement blue-green deployment or rolling update strategy",
                    "DevOps Team",
                )
            )
        ...
        if constraints.get("data_volume_gb", 0) > 5000:
            additional_risks.append(
                RiskItem(
                    "technical",
                    "Large data volumes may cause extended migration time",
                    "high",
                    "medium",
                    "medium",
                    "Implement parallel processing and progress monitoring",
                    "Data Team",
                )
            )
        ...
        if compliance_reqs:
            additional_risks.append(
                RiskItem(
                    ...
                    "high",
                    "high",
                    "Ensure all compliance checks are integrated into migration process",
                    "Compliance Team",
                )
            )
    ...
    def generate_human_readable_plan(self, plan: MigrationPlan) -> str:
        ...
        output.append(
            f"Estimated Duration: {plan.estimated_duration_hours} hours ({plan.estimated_duration_hours / 24:.1f} days)"
        )
...
def main():
    ...
    parser.add_argument(
        "--input", "-i", required=True, help="Input migration specification file (JSON)"
    )
    ...
    parser.add_argument(
        "--validate", action="store_true", help="Validate migration specification only"
    )
